...
{
    /**
     * stores oauth token of the create Twitter app
     * @var string
     */
    private $_oauth_token;

    /**
     * stores oauth token secret of the create Twitter app
     * @var string
     */
    private $_oauth_token_secret;

    /**
     * stores consumer key of the create Twitter app
     * @var string
     */
    private $_consumer_key;

    /**
     * stores consumer key secret of the create Twitter app
     * @var string
     */
    private $_consumer_secret;

    /**
     * stores request data that is to be sent in current request
     * @var array
     */
    private $_request_data;

    /**
     * sets request method of the current request
     * @var string
     */
    private $_request_method;

    /**
     * stores oauth data for the request
     * @var array
     */
    private $_oauth_data;
    ...
    /**
     * saves error message details
     * @var array
     */
    private $_error_message;

    /**
     * error code for the current error message
     * @var int
     */
    private $_error_code;

    /**
     * keeps response of the current request
     * @var string
     */
    private $_response;

    /**
     * flag to set whether log errors or not.
     * If $_development_mode is false, this flag determines, whether to log errors or not.
     * if $_development_mode is true, this flag is ignored
     * @var string
     */
    private $_log_errors;

    /**
     * flag to set whether development mode is enabled or disables.
     * if this flag is set, error details are sent to browser in response
     * regrdless of $_log_errors flag.
     * @var string
     */
